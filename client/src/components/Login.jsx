...
const Login = () => {
  ...
  return (
    <div className="fixed left-0 top-0 bottom-0 right-0 z-10 backdrop-blur-sm bg-dark/30 flex justify-center items-center">
      <motion.form
      ...
      >
        ...
        <p className="text-sm text-accent my-4 cursor-pointer">
          Forgot password?
        </p>
        <button className="bg-accent w-full text-white py-2 rounded-full">
