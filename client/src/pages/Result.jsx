    ...
    >
      ...
      {!isImageLoaded && (
        <div className="flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full">
          ...
          <button
            type="submit"
            className="bg-dark px-10 sm:px-16 py-3 rounded-full"
          >
            Generate
          </button>
        </div>
      ...
      {isImageLoaded && (
        <div className="flex flex-wrap gap-2 justify-center items-center text-white text-sm p-0.5 mt-10 rounded-full">
          <p
            ...
            className="bg-transparent border border-secondary text-black px-8 py-3 rounded-full cursor-pointer"
          >
            Generate Another
          </p>
          <a
            href={image}
            download
            className="bg-dark px-10 py-3 rounded-full cursor-pointer"
          >
            Download
          </a>
        </div>
